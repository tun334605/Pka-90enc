...
local scriptName = "Script mod by Minh Lộc_Version 1078🟢"
...
local Acorn = {
    ["acornS"]  = "h 00 00 00 00 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",    
}
local Gather = {
...
local Camera = {
    ["cameraS"]  = "h FC FF AF C1 00 00 D0 40 9A 99 99 3E 00 00 7A 44",    
}
local Size = {
...
local AcornMod = {
    ["acorn1"] = "h D4 FE FF FF 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",  -- 300 lượt
    ["acorn2"] = "h 7C FC FF FF 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",  -- 900 lượt
    
    ["acorn1.1"] = "h E8 FE FF FF 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",  -- 280 lượt
    ["acorn1.2"] = "h FC FE FF FF 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",  -- 260 lượt
    ["acorn1.3"] = "h 10 FF FF FF 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",  -- 240 lượt
    ["acorn1.4"] = "h 24 FF FF FF 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",  -- 220 lượt
    ["acorn1.5"] = "h 38 FF FF FF 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",  -- 200 lượt
    
  
    ["acorn2.1"] = "h 90 FC FF FF 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",  -- 880 lượt
    ["acorn2.2"] = "h A4 FC FF FF 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00", -- 860 lượt
    ["acorn2.3"] = "h B8 FC FF FF 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",  -- 840 lượt
    ["acorn2.4"] = "h CC FC FF FF 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",  -- 820 lượt
    ["acorn2.5"] = "h E0 FC FF FF 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",  -- 800 lượt

    
    ["acorn3.1"]  = "h 01 00 00 00 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",--1
    ["acorn3.2"]  = "h 02 00 00 00 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",--2
    ["acorn3.3"]  = "h 03 00 00 00 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",--3
    ["acorn3.4"]  = "h 04 00 00 00 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",--4
    ["acorn3.5"]  = "h 05 00 00 00 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",--5
    ["acorn3.6"]  = "h 06 00 00 00 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",--6
    ["acorn3.7"]  = "h 07 00 00 00 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",--7
    ["acorn3.8"]  = "h 08 00 00 00 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",--8
    ["acorn3.9"]  = "h 09 00 00 00 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",--9
    ["acornS3.10"]  = "h 0A 00 00 00 00 00 00 00 B1 B3 00 00 CB B3 00 00 00 00 00 00 00 00 00 00",--10
}
local GatherMod = {
...
local CameraMod = {
    ["camera10"] = "h FC FF AF C1 00 00 20 41 9A 99 99 3E 00 00 7A 44",
    ["camera15"] = "h FC FF AF C1 00 00 70 41 9A 99 99 3E 00 00 7A 44",
    ["camera20"] = "h FC FF AF C1 00 00 A0 41 9A 99 99 3E 00 00 7A 44",
    ["camera30"] = "h FC FF AF C1 00 00 F0 41 9A 99 99 3E 00 00 7A 44",
...
local function AcornMenu()
    while true do
        ...
        if ch == 2 then
            local mode = gg.choice({
                "Reset CN 300 Lượt (300→200)[280,260,240,220,200]",
                "Reset CN 900 Lượt (900→800)_[880,860,840,820,800]",
...
local function CameraMenu()
    while true do
        ...
        if ch == 1 then
            ...
            gg.toast("🔍 Đang tải dữ liệu ...")
            gg.clearResults()
            gg.searchNumber(Camera["cameraS"], gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0, -1)
            ...
            if not results or #results == 0 then
                ...
                local mode = gg.choice({
                    ...
                    "C30",
                    "❌ Hủy"
                }, nil, "Chọn chế độ bạn muốn áp dụng:")

                if mode == nil or mode == 5 then
                    gg.toast("❌ Đã hủy.")
                else
                    local modeKey = (mode == 1 and "camera10") or (mode == 2 and "camera15") or (mode == 3 and "camera20") or (mode == 4 and "camera30")

                    local newValue = CameraMod[modeKey]
                    ...
                    if freezeChoice == 1 then
                        ...
                        local choiTo = (mode == 1 and "C10") or (mode == 2 and "C15") or (mode == 3 and "C20") or (mode == 4 and "C30")
        ...
        -- ====== 2: Reset về mặc định (tìm giá trị đang mod rồi reset về cameraS) ======
        if ch == 2 then
            gg.toast("Reset")
            ...
            if mode == nil or mode == 5 then
                ...
                local currentValue = CameraMod[modeKey]
                ...
                if #results == 0 then
                    ...
                    gg.editAll(Camera["cameraS"], gg.TYPE_BYTE)
                    gg.clearResults()
...
local function mainMenu()
    while true do
        ...
        if choice == 13 then CameraMenu() end
